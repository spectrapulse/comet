...
## [1.52.0](https://github.com/spectrapulse/comet/compare/v1.51.0...v1.52.0) (2024-12-06)
...
* ability to enable/disable title match check (TITLE_MATCH_CHECK env var) ([755c4fb](https://github.com/spectrapulse/comet/commit/755c4fb8d21e74576aa615c7d84b399ebedeb45a))
...
* add media fusion hashes ([ece4600](https://github.com/spectrapulse/comet/commit/ece4600ddec3bfc64cd39ce3fdb667b022c2cd35))
* Add metadata to result title ([33f3f96](https://github.com/spectrapulse/comet/commit/33f3f96b8c0d2416c8cdb1db8614970f714708ae))
* add multi to languages ([da4d1d7](https://github.com/spectrapulse/comet/commit/da4d1d7cc2a4fc590c6acb0a7c0f43be9fc54568))
* add real torrent_size in results ([33ef5b1](https://github.com/spectrapulse/comet/commit/33ef5b119fa9f01bb914ba969bf19f95b61a761f))
* add search term ([fdb62ab](https://github.com/spectrapulse/comet/commit/fdb62ab60adb046e92279f7f5c2578d9b54fd8bc))
* autplay ([1147845](https://github.com/spectrapulse/comet/commit/1147845640a628bda61e0355f186d425587cb989))
* config string now sent to console when copy/install button clicked ([9f46fa9](https://github.com/spectrapulse/comet/commit/9f46fa98ddfdd9a0466f200144cd72dc09a8e160))
* custom MediaFusion urls for elfhosted &lt;3 ([bc29eb9](https://github.com/spectrapulse/comet/commit/bc29eb9582dca426ad58cc770f7d7d4d0cd6acd0))
* custom results title ([fa800ef](https://github.com/spectrapulse/comet/commit/fa800ef6b6a0f8ba91ebe2ebfa21147f9cb667a1))
* debrid download links are now cached for 1h (massive speed improvement) ([aab0b91](https://github.com/spectrapulse/comet/commit/aab0b918bd205b668ce15510c13d672efb5ed923))
* debrid-link is now default ([253eadc](https://github.com/spectrapulse/comet/commit/253eadc322e8138f61b638567aaaed9d3c23b85a))
* Debrid-Link support ([dadca78](https://github.com/spectrapulse/comet/commit/dadca784b1ddddbbde1d7db59e2d12039a99f60a))
...
* direct torrent!!! omg!!!! no way what ([e621c84](https://github.com/spectrapulse/comet/commit/e621c84237b3514d9b954666c182b135cc686f99))
* disable indexer select if indexer manager disabled ([2907a0e](https://github.com/spectrapulse/comet/commit/2907a0e25ca3da405b309e0c90ce7d191e7825f7))
* easydebrid support ([15b22e7](https://github.com/spectrapulse/comet/commit/15b22e75aa4c4e0d32e3dbc8d76cd1c45eeedde6))
* elfhosted debugging ([85912a2](https://github.com/spectrapulse/comet/commit/85912a273b12a5a3fae1b7a4d5546022d304b4de))
...
* error videos added to playback ([83668ea](https://github.com/spectrapulse/comet/commit/83668ea3c15858504dfbb58fae5764995dc30bf9))
* faster json stuff and better result ordering ([d8571d1](https://github.com/spectrapulse/comet/commit/d8571d189bda8bf3130695e921d5225dabddf698))
* faster than ever, better results ([19f9cc4](https://github.com/spectrapulse/comet/commit/19f9cc48ae83e27b43fdbb8541ec8d6b6f2878df))
* faster, prowlarr pack support, max size, tracker name in results and more... ([0fabd79](https://github.com/spectrapulse/comet/commit/0fabd79a6e07b33fde76074ebbb5193cea7b9d10))
* fetch previous settings from stremio configure ([b42f4fb](https://github.com/spectrapulse/comet/commit/b42f4fbc96622a48f035de10e711bae2c9a9e2d2))
...
* Kitsu support ([b641c69](https://github.com/spectrapulse/comet/commit/b641c69c04173b82386a4e150fccba2e078a85be))
* language unknown support ([6f7c79f](https://github.com/spectrapulse/comet/commit/6f7c79f91dffabd28bcce667be6c72837711414b))
* new admin dashboard for debrid proxy stream + title year check + ip-based max connections for debrid proxy stream ([1d11ac4](https://github.com/spectrapulse/comet/commit/1d11ac46bde0c951ee0c3afa746e83a46bb8474f))
* new db structure ([8c3a81a](https://github.com/spectrapulse/comet/commit/8c3a81a61fb9f0195c7edd67efcd577dfc2cf458))
* pack support for alldebrid ([30fe1ef](https://github.com/spectrapulse/comet/commit/30fe1ef6bd97aec5545aa808bf77db9ae4a8d4fa))
* PostgreSQL support ([8f46d7f](https://github.com/spectrapulse/comet/commit/8f46d7f1829148190d27adf0d35ed64bf233d029))
* premiumize support ([ab846a7](https://github.com/spectrapulse/comet/commit/ab846a76134fa2c0ebf6091a878bf3f0aeb93ff4))
* random addon id ([1b6a80b](https://github.com/spectrapulse/comet/commit/1b6a80bbe5800771774adeb469d861919dc3f70d))
* realdebrid real ip ([479aa8e](https://github.com/spectrapulse/comet/commit/479aa8e527ebfeec01ffcde5c825b0a5af19538e))
* realTitle in results for prowlarr support ([57440a9](https://github.com/spectrapulse/comet/commit/57440a9d08d2630ed084cfd07b374c9d9a96ef19))
...
* save settings on Stremio configure button ([6dd22cc](https://github.com/spectrapulse/comet/commit/6dd22ccce7858967c287ad028ea011caefffd2af))
...
* show language emoji in results ([d9e15e7](https://github.com/spectrapulse/comet/commit/d9e15e7e88244eca1c264221ca71e38b4dab7dbc))
...
* torbox integration ([db1a003](https://github.com/spectrapulse/comet/commit/db1a003a7b6225ea06dfd118cb8247dd2b385a1e))
...
* torrentio scraper ([94c21d9](https://github.com/spectrapulse/comet/commit/94c21d962d784405d0c09e2986393b90c497dfd9))
* use debrid proxy for torrentio (bypass Cloudflare server IP blacklist) ([5d02247](https://github.com/spectrapulse/comet/commit/5d02247021ca897aa79842bde1bbb56817a58967))
* wrong password warning for debrid stream proxy ([6b8303b](https://github.com/spectrapulse/comet/commit/6b8303b2745bf3191a60f0a9c25d0d2bd81c4436))
* zilean only mode ([123378f](https://github.com/spectrapulse/comet/commit/123378ff351ed4b6df15f0a33c6d1227f6f91fc5))


### Bug Fixes

* a ([949b83b](https://github.com/spectrapulse/comet/commit/949b83b5f5c53dea7231cd57d829a85f8da533d5))
* add missing env var ([77ef84a](https://github.com/spectrapulse/comet/commit/77ef84a89306fe1bb63dc0178024a6c28fe6c262))
* add torrentio scraper to features ([27d23a5](https://github.com/spectrapulse/comet/commit/27d23a5fa6bb15a92be61ec7701207554864e422))
* add trackers to results ([9295fd2](https://github.com/spectrapulse/comet/commit/9295fd2f8315e0e1d4586a059d2910a9c348a62a))
...
* alldebrid .fr to .com ([22c4445](https://github.com/spectrapulse/comet/commit/22c444573766bba40ac5d40fe83a0bc2fbf04ec3))
* alldebrid get files ([4bf8e88](https://github.com/spectrapulse/comet/commit/4bf8e88c0be7e82349581c8027f4ecb407ec99de))
* alldebrid support ([1ea4464](https://github.com/spectrapulse/comet/commit/1ea446471ce7e9673724952a24075e64672d3510))
* b ([665e840](https://github.com/spectrapulse/comet/commit/665e8407e3fcab3fe3ccb84b60b12c733fc609e8))
* bye samples ([efcf44d](https://github.com/spectrapulse/comet/commit/efcf44dbdff688031771e6834ca4d3244489fc3c))
* coding blind ([2a5002a](https://github.com/spectrapulse/comet/commit/2a5002a3a134429fb9cffc708ac1973dceff0b40))
* correctly handle unsuccessful api calls ([c14195e](https://github.com/spectrapulse/comet/commit/c14195e6027e9fa70cd16245b5bd916b4806901e))
* db caching issue ([8122689](https://github.com/spectrapulse/comet/commit/812268971d0dcd030df36b004083ee8a922fda5d))
* db error ([d1232ce](https://github.com/spectrapulse/comet/commit/d1232cec61b7ecc7d639098d949dc8696822a274))
* debrid download link caching not working in certain case ([271dbb6](https://github.com/spectrapulse/comet/commit/271dbb6f43481c509e7a74018d0c804c263eadcd))
* debrid stream proxy on some devices ([240364b](https://github.com/spectrapulse/comet/commit/240364bd883070cf2556fb2b7bdd89fa4a1230f6))
* Delete poetry.lock ([833bb33](https://github.com/spectrapulse/comet/commit/833bb332c4b4899372b08007c57db4084752339e))
* divising by 0 ([dcef22a](https://github.com/spectrapulse/comet/commit/dcef22a46d6331befae31d51a977ed714868366f))
* do the maths client side ([b0aa42c](https://github.com/spectrapulse/comet/commit/b0aa42c519767b61ed9d3dfdec7eceed79e127ae))
* easier for elfhosted to process ([6443fa1](https://github.com/spectrapulse/comet/commit/6443fa1b5fe601cbdf27e208bd80feaf3ac3156d))
* easydebrid tv shows ([e40163f](https://github.com/spectrapulse/comet/commit/e40163f509fdbf41b914a136d6eea5ec2bacb891))
* fail build ([9e7407d](https://github.com/spectrapulse/comet/commit/9e7407d7ced4a1d570e11c350dd5b6ce4a878db6))
* faster (we title match check before doing the rest) ([19fc235](https://github.com/spectrapulse/comet/commit/19fc235e838bcfb6d3d7e06f95309ff72c491fd5))
* faster debrid file parsing ([bf846fa](https://github.com/spectrapulse/comet/commit/bf846fa8a8d8444d13f404ec1651e7f0d71b4697))
* fix 2160p issue ([5ca4aa5](https://github.com/spectrapulse/comet/commit/5ca4aa59a0b704f77ab45190f2e03fc83e75023e))
* hope ([0086f3f](https://github.com/spectrapulse/comet/commit/0086f3f90ed31dba29d5e5ad0f6b6451f9144e91))
* I fixed it I think guys ([86ea5d5](https://github.com/spectrapulse/comet/commit/86ea5d5a3d2af47e3698c04f160e195cf8def614))
* I just want to release ([9bb4a4e](https://github.com/spectrapulse/comet/commit/9bb4a4ecc0c0e9449fc57b37b142025c314c5dda))
* IMDb metadata retriever ([914c5d2](https://github.com/spectrapulse/comet/commit/914c5d2d455cc4f12f738a4e3aa014aa816c619b))
* imdb metadata wrong name ([0ecba3e](https://github.com/spectrapulse/comet/commit/0ecba3e64aaf6b3f5dad47f4f5527f0a8732d57a))
...
* improves prowlarr compatibility ([7c0ee96](https://github.com/spectrapulse/comet/commit/7c0ee96dafb4a14db02c66e8cfaf2dd5ac05273c))
* index error ([e94c8e2](https://github.com/spectrapulse/comet/commit/e94c8e278a610f7ee88d513958407d389d2c0515))
* int to float ([a0d72d8](https://github.com/spectrapulse/comet/commit/a0d72d8849b289a6f7c7be4e4219a46ccdd82ee2))
* ip debrid ([057126b](https://github.com/spectrapulse/comet/commit/057126bbd00f818075969e5e73eff3e834a8ef1f))
* Jinja2 missing sometimes ([11a96b7](https://github.com/spectrapulse/comet/commit/11a96b705b29b7a8dd72d81c6d2f6957360bfea9))
* jinja2????? ([55fe625](https://github.com/spectrapulse/comet/commit/55fe625c595ac2b8eea5ac3ee98219bbc6adeddf))
* json dumps ([267a764](https://github.com/spectrapulse/comet/commit/267a76468ed90382ae2776089da7051cc4ccca05))
* json lib is not used anymore ([af6d009](https://github.com/spectrapulse/comet/commit/af6d009651cca60b8a5fb3c04a4a585ac40039b0))
* latin and spanish separated ([2421667](https://github.com/spectrapulse/comet/commit/24216678b8fca0ab8edd48d239fb772f06712b5f))
* log error ([9fb92eb](https://github.com/spectrapulse/comet/commit/9fb92eb3780e8b312cdb97dd566f699846eaec4e))
* lower not needed ([ff60d91](https://github.com/spectrapulse/comet/commit/ff60d91091f465db1c5b06eeb3ad8efd064f2c24))
* magical db fix improving speed by 5000% ([67a20be](https://github.com/spectrapulse/comet/commit/67a20be6b1bac652085d97743e0251fbdaec01ae))
* maxSize reset to 0 ([05ea53b](https://github.com/spectrapulse/comet/commit/05ea53b5b1cbef18b757afacc0c4806d3d90aa51))
* metadata ([23966f2](https://github.com/spectrapulse/comet/commit/23966f22887e1d744f2342a97d7b39652155ddb1))
* metadata ([809e32b](https://github.com/spectrapulse/comet/commit/809e32bb9c727076be12ab88b073b86213b50e12))
* metadata ([81ff5bc](https://github.com/spectrapulse/comet/commit/81ff5bc71b1b8a683f662fa9af7c364cf6046b85))
* metadata retriever ([8f4e133](https://github.com/spectrapulse/comet/commit/8f4e13392ac65ce6b6d23f26f4bfafb629201574))
* missing year metadata ([4a4dfb6](https://github.com/spectrapulse/comet/commit/4a4dfb68923d4c496b8e837eb3a238d6ba21ae95))
* not retrieving saved stremio settings if all selected ([42c5863](https://github.com/spectrapulse/comet/commit/42c5863297807f231e04f2eb25510b146c6f789a))
...
* prowlarr ([a6179bf](https://github.com/spectrapulse/comet/commit/a6179bf3b029619286edbc1a7746091d0d254d7b))
* prowlarr indexer ([4003fb4](https://github.com/spectrapulse/comet/commit/4003fb4fc06c70364fb7d64a077a334d303de085))
* prowlarr infoHash ([71738ee](https://github.com/spectrapulse/comet/commit/71738ee3a65115694a219b4e55e645df2ccef138))
* proxy is not needed with premiumize ([82fb354](https://github.com/spectrapulse/comet/commit/82fb354ed10a471f1ac3d9b807af71c1ae6c80de))
* proxy stream ([1ceeff5](https://github.com/spectrapulse/comet/commit/1ceeff57223f521b006b4311c314ed62f56096fe))
* realdebrid ip stuff ([6ee6b92](https://github.com/spectrapulse/comet/commit/6ee6b928a57351a82af284b3c6446bcbf01a8e10))
* realdebrid pack caching issue ([0a9eb03](https://github.com/spectrapulse/comet/commit/0a9eb03c5895fffaff8f13c6eb96d546487dcccd))
...
* remove fullstacksample docker compose as it needs to be changed a lot ([7533ecb](https://github.com/spectrapulse/comet/commit/7533ecb4b08a349b25a1bce2e70b1481fc3407bd))
* revert IMDb metadata bug ([595c2c0](https://github.com/spectrapulse/comet/commit/595c2c0da9f6a94a930e82d1e555cafefa343ad2))
* sample detection ([fe93bac](https://github.com/spectrapulse/comet/commit/fe93bacf23ee9911d450cd37631b813a7572af2b))
...
* slightly improve anime results ([c9f230c](https://github.com/spectrapulse/comet/commit/c9f230c9cb8649dbe5f0dfab923039785b4c885b))
* something ([5b5a9ce](https://github.com/spectrapulse/comet/commit/5b5a9ce3c341a9e67c29cd6a623640aa3fd7d0cf))
* speed up playback ([683a826](https://github.com/spectrapulse/comet/commit/683a82656aa35a90a891ef902f59acb967c078e4))
* sqlite download_link caching ([34c93c6](https://github.com/spectrapulse/comet/commit/34c93c6d3b0d77a8573e810e1f6cefff71a83e85))
* title parsing ([732021c](https://github.com/spectrapulse/comet/commit/732021c99b8004192b15d29d5b63a39bce893568))
* torbox faster (removed useless checks) ([dfaf12b](https://github.com/spectrapulse/comet/commit/dfaf12b6afcf7d1aa2d7d998bdf9dedef8ec0502))
* torbox ignore empty data ([f971255](https://github.com/spectrapulse/comet/commit/f971255c0f6da4207e015d0a7d779b9a89afdb91))
* torrentio ([165cb25](https://github.com/spectrapulse/comet/commit/165cb256d2c4e27020eb775d52de299cddbdc0f5))
* torrentio cloudflare bypass ([d9c98a7](https://github.com/spectrapulse/comet/commit/d9c98a75cb4e101d00395022549499b9a7d3965b))
* torrentio proxy ([b098bb1](https://github.com/spectrapulse/comet/commit/b098bb1ed9a60af89e173c527bf4bb579a91a29c))
* torrents faster ([ef53efe](https://github.com/spectrapulse/comet/commit/ef53efe7337679cc1cf1843d1efa956c09cad62a))
* try to fix Nvidia shield debrid stream proxying ([bdb22dc](https://github.com/spectrapulse/comet/commit/bdb22dcc63b4ca6fd014faaf287b7d8034093c12))
* typo causing errors ([7584af6](https://github.com/spectrapulse/comet/commit/7584af66dd19d3a2c089f75b9f6cf1646ddbc25c))
* update hashinfo ([c15206b](https://github.com/spectrapulse/comet/commit/c15206b4b410fc685fbbcd7f31df574553ca6cd5))
* update manifest for animes support ([8ee3220](https://github.com/spectrapulse/comet/commit/8ee32205f14ad098dc96c1f9aea3f78314807431))
* useless repeated code ([fa8ce05](https://github.com/spectrapulse/comet/commit/fa8ce0546575eb7e93560dc25649ea9620a2e554))
* valid debrid api key not needed anymore if results already cached ([e94e224](https://github.com/spectrapulse/comet/commit/e94e2249a0ac9bd99eaee1f90dd3cdfd41bc43ba))
...
* webui copy button for non secured environments ([8eda672](https://github.com/spectrapulse/comet/commit/8eda6720ff3b27bc748b9329fc0a5442310aa291))
* weird shit ([1176b2a](https://github.com/spectrapulse/comet/commit/1176b2a84233f705033b142b1492c2bdc7da5b77))
* where is the client ([c532656](https://github.com/spectrapulse/comet/commit/c532656b3bba916a5df8cbdcf306b822ef94a871))
* wrong debrid stream proxy password warning being showed everytime ([0514484](https://github.com/spectrapulse/comet/commit/05144847976207a9780460a92e7c1b1ff20f10f1))
* wtf ([b47676c](https://github.com/spectrapulse/comet/commit/b47676cc86758964bb9feb5a4ebcccc97ae7ef02))
* year_end for kitsu ([f1f4224](https://github.com/spectrapulse/comet/commit/f1f422440df81cf0b02b469ff37ce9b65a963bea))
* zilean ([6a272fc](https://github.com/spectrapulse/comet/commit/6a272fcf7638581a171ea7ea20aaa5854c3552cc))
* zilean ([40b62b2](https://github.com/spectrapulse/comet/commit/40b62b29dc351775da3c7d914203579abfede646))
* zilean 1.5 ([12a9bc5](https://github.com/spectrapulse/comet/commit/12a9bc59ef545ff2ff86637791609fd8e7ffec57))
* zilean filtering speed fixed ([dad68c2](https://github.com/spectrapulse/comet/commit/dad68c256e93df99a3aa5ed810dc495dc67d739d))
* zilean multithreaded ([73b0a35](https://github.com/spectrapulse/comet/commit/73b0a35d38dd29c6b9ba4dad116f8f86f5086064))
